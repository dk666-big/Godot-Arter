...
### Phase 4：Godot 导出 ✅ 已完成
- [x] 音频导出功能（WAV 格式）
- [x] Godot 脚本生成（audio_registry.gd）
- [x] 音效库管理

### Phase 5：待开发
- [ ] 接入外部音频生成 API（Suno/Udio）
- [ ] 语音合成（TTS）功能
- [ ] 高级音频编辑（变调、混响）
- [ ] 循环点精确设置
...
### P2（增强）✅ 已完成
- [x] 分支剧情树模块框架
- [x] 语音合成（TTS）- Web Speech API 集成
- [x] 图片风格迁移 - 像素/油画/霓虹/故障/蒸汽波
- [x] 远程预览 ~~(已取消)~~

### P3（优化）✅ 已完成
- [x] TileSet 可视化编辑 - 碰撞/地形/事件绘制
- [x] 自动寻路测试 - A* 算法
- [x] 批量重命名 - 多种模式
- [x] 智能推荐 - 素材归类分析
- [x] 全局快捷键 - Ctrl+S/G/F 等
